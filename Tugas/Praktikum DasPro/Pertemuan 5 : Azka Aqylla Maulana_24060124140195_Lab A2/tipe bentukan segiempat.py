# Nama File   = tipe bentukan segiempat
# Nama        = Azka A. Maulana
# NIM         = 24060124140195
# Tanggal     = 29 September 2024 (tanggal mulai menulis di VsCode)
# Deskripsi   = menjawab soal tipe bentukan segiempat
...
# APLIKASI
print(AreaBujurSangkar(MakeSegiempat( MakePoint(1, 3), MakePoint(2, 3), MakePoint(1, 2), MakePoint(2, 2))))
print(IsBujurSangkar(MakeSegiempat(MakePoint(1, 3), MakePoint(2, 3), MakePoint(1,   2), MakePoint(2, 2))))
